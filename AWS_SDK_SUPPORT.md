...
This document lists all AWS SDK features from the [Smithy AWS integrations](https://smithy.io/2.0/aws/index.html) specification and their support status in smithy-erlang.
...
| Feature | Status | Notes |
|---------|--------|-------|
| [AWS Signature Version 4 (SigV4)](https://smithy.io/2.0/aws/aws-auth.html#aws-auth-sigv4-trait) | ✅ | Full implementation with canonical request, string-to-sign, signature calculation |
| [Credential Provider Chain](https://smithy.io/2.0/aws/aws-auth.html) | ✅ | Environment variables, `~/.aws/credentials`, provider chain |
...
| Feature | Status | Notes |
|---------|--------|-------|
| [Service Trait (`aws.api#service`)](https://smithy.io/2.0/aws/aws-core.html#aws-api-service-trait) | ⚠️ | Uses hardcoded detection; does not dynamically extract all metadata |
...
| [Dual-Stack Endpoints](https://smithy.io/2.0/aws/aws-endpoints-region.html#aws-endpoints-dualstackonlyendpoints-trait) | ⚠️ | Basic support via endpoints.json |
| [FIPS Endpoints](https://smithy.io/2.0/aws/aws-endpoints-region.html) | ⚠️ | Basic support via endpoints.json |
