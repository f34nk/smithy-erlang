...
/**
 * EC2 Query Protocol implementation for EC2, Auto Scaling, and other EC2-based AWS services.
 * 
 * Key characteristics:
 * - POST requests to "/"
...
public class Ec2QueryProtocol implements Protocol {
    ...
    /**
     * Creates an EC2 Query protocol handler.
     */
    ...
    public void generateOperation(
        ...
        writer.indent();
        writer.write("#{<<\"Response\">> := #{<<\"Errors\">> := Errors}} ->");
        writer.indent();
        ...
        writer.indent();
        writer.write("%% Multiple errors - use first one");
        ...
        writer.write("_ ->");
        writer.indent();
        writer.write("%% Fallback for unexpected error structure");
